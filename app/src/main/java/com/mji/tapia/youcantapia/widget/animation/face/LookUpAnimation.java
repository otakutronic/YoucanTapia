...
public class LookUpAnimation extends Animation {

    public enum LookUpEvent implements Event{
        LOOK_UP_EYES_UP,
        LOOK_UP_EYES_BACK_START,
        LOOK_UP_ANIM_FINISH
    }
    ...
    int lookUpFrameDelay;
    int lookUpFrameDelayCountDown;

    float speedBlurAngleOffset;

    int upTimeInMilli;

    public LookUpAnimation(Context context){
        leftBlankEyeX = 204;
        eyeBlankEyeY = 142;
        rightBlankEyeX = 640;
        eyeBlankWidth = 435;
        ...
        lookUpFrameDelay = (int) ((double)upTimeInMilli/frameLengthInMilliseconds);;
        lookUpFrameDelayCountDown = 0;
    ...
    protected void update(long frameSkip) {
        if(lookUpFrameDelayCountDown > 0){
            lookUpFrameDelayCountDown -= frameSkip;
            if(lookUpFrameDelayCountDown <= 0){
                backAnimationFrameIndex = 0;
                if(animationListener != null) {
                    animationListener.onEvent(LookUpAnimation.this, LookUpEvent.LOOK_UP_EYES_BACK_START);
                }
            }
        ...
        if(startAnimationFrameIndex < startAnimationFrameCount){
            ...
            if(startAnimationFrameIndex >= startAnimationFrameCount){
                ...
                lookUpFrameDelayCountDown = lookUpFrameDelay;
                if(animationListener != null) {
                    animationListener.onEvent(LookUpAnimation.this, LookUpEvent.LOOK_UP_EYES_UP);
                }
            }
            else {
            ...
            if(backAnimationFrameIndex >= backAnimationFrameCount){
                ...
                startAnimationFrameIndex = 0;
                if(animationListener != null) {
                    animationListener.onEvent(LookUpAnimation.this, LookUpEvent.LOOK_UP_ANIM_FINISH);
                }
            }
            else {
...
//        canvas.drawBitmap(leftEye,
//                leftBlankEyeCenterX + (int)(eyeRadius*Math.cos(leftEyeAngle + speedBlurAngleOffset*leftEyeRadialSpeed)) - irisWidth/2,
//                blankEyeCenterY + (int)(eyeRadius*Math.sin(leftEyeAngle + speedBlurAngleOffset*leftEyeRadialSpeed)) - irisHeight/2,
//                leftEyePaint1);
//        canvas.drawBitmap(leftEye,
//                leftBlankEyeCenterX + (int)(eyeRadius*Math.cos(leftEyeAngle - speedBlurAngleOffset*leftEyeRadialSpeed)) - irisWidth/2,
//                blankEyeCenterY + (int)(eyeRadius*Math.sin(leftEyeAngle - speedBlurAngleOffset*leftEyeRadialSpeed)) - irisHeight/2,
//                leftEyePaint2);
//        canvas.drawBitmap(rightEye,
//                rightBlankEyeCenterX + (int)(eyeRadius*Math.cos(rightEyeAngle + speedBlurAngleOffset*rightEyeRadialSpeed)) - irisWidth/2,
//                blankEyeCenterY + (int)(eyeRadius*Math.sin(rightEyeAngle + speedBlurAngleOffset*rightEyeRadialSpeed)) - irisHeight/2,
//                rightEyePaint1);
//        canvas.drawBitmap(rightEye,
//                rightBlankEyeCenterX + (int)(eyeRadius*Math.cos(rightEyeAngle - speedBlurAngleOffset*rightEyeRadialSpeed)) - irisWidth/2,
//                blankEyeCenterY + (int)(eyeRadius*Math.sin(rightEyeAngle - speedBlurAngleOffset*rightEyeRadialSpeed)) - irisHeight/2,
//                rightEyePaint2);
    ...
    public void setUpTimeInMilli(int upTimeInMilli) {
        this.upTimeInMilli = upTimeInMilli;
        lookUpFrameDelay = (int) (animationSpeed*(double)this.upTimeInMilli/frameLengthInMilliseconds);
    }

    @Override
    public void setAnimationSpeed(double animationSpeed) {
        super.setAnimationSpeed(animationSpeed);
        lookUpFrameDelay= (int) (animationSpeed*(double)upTimeInMilli/frameLengthInMilliseconds);
