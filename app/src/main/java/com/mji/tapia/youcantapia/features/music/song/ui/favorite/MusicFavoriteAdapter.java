...
public class MusicFavoriteAdapter extends BaseAdapter {
    ...
    private PublishSubject<MusicSong> musicSongChangePublishSubject;

    MusicFavoriteAdapter(Context context, List<MusicSong> musicSongList) {
        this.context = context;
        musicSongChangePublishSubject = PublishSubject.create();
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.favorite_iv.setOnClickListener(v -> {
            ...
            musicSongChangePublishSubject.onNext(musicSong);
            musicSongList.remove(musicSong);
    ...
    public Observable<MusicSong> getMusicSongChangePublishSubject() {
        return musicSongChangePublishSubject;
    }
}
